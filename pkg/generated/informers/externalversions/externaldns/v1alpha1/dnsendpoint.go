...
import (
	...
	externaldnsv1alpha1 "github.com/carlosfrancia/externaldns-k8s-client/pkg/apis/externaldns/v1alpha1"
	versioned "github.com/carlosfrancia/externaldns-k8s-client/pkg/generated/clientset/versioned"
	internalinterfaces "github.com/carlosfrancia/externaldns-k8s-client/pkg/generated/informers/externalversions/internalinterfaces"
	v1alpha1 "github.com/carlosfrancia/externaldns-k8s-client/pkg/generated/listers/externaldns/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.ExternaldnsV1alpha1().DNSEndpoints(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ExternaldnsV1alpha1().DNSEndpoints(namespace).Watch(context.TODO(), options)
			},
		},
...
func (f *dNSEndpointInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&externaldnsv1alpha1.DNSEndpoint{}, f.defaultInformer)
}

func (f *dNSEndpointInformer) Lister() v1alpha1.DNSEndpointLister {
	return v1alpha1.NewDNSEndpointLister(f.Informer().GetIndexer())
}
